...
GO
ALTER DATABASE HumanResources ADD FILE (NAME = F0, FILENAME = 'E:\20762C-ENU-Allfiles\Labfiles\Lab03\Starter\SetupFiles\F0.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG0;
GO
ALTER DATABASE HumanResources ADD FILEGROUP FG1
GO
ALTER DATABASE HumanResources ADD FILE (NAME = F1, FILENAME = 'E:\20762C-ENU-Allfiles\Labfiles\Lab03\Starter\SetupFiles\F1.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG1;
GO
ALTER DATABASE HumanResources ADD FILEGROUP FG2
GO
ALTER DATABASE HumanResources ADD FILE (NAME = F2, FILENAME = 'E:\20762C-ENU-Allfiles\Labfiles\Lab03\Starter\SetupFiles\F2.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG2;
GO
ALTER DATABASE HumanResources ADD FILEGROUP FG3
GO
ALTER DATABASE HumanResources ADD FILE (NAME = F3, FILENAME = 'E:\20762C-ENU-Allfiles\Labfiles\Lab03\Starter\SetupFiles\F3.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG3;
GO
