...
ON PRIMARY 
( 
	NAME = N'HR', FILENAME = N'E:\20762C-ENU-Allfiles\Labfiles\Lab03\Starter\SetupFiles\HumanResources.mdf' , SIZE = 55360KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB 
)
LOG ON 
( 
	NAME = N'HR_log', FILENAME = N'E:\20762C-ENU-Allfiles\Labfiles\Lab03\Starter\SetupFiles\HumanResources_log.ldf' , SIZE = 32960KB , MAXSIZE = 2048GB , FILEGROWTH = 10%
);
GO
